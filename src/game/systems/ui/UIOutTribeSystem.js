define([
	...
	var UIOutTribeSystem = Ash.System.extend({
		...
		createCampRow: function (campOrdinal, rowID) {
			...
			rowHTML += "<td class='camp-overview-btn'><button class='btn-mini action action-move' id='" + btnID + "' action='" + btnAction + "'>前往</button></td>";
		...
		updateCampRowStats: function (node, rowID) {
			...
			UIConstants.updateCalloutContent("#camp-overview tr#" + rowID + " .camp-overview-stats-evidence", "证据: " + UIConstants.roundValue(evidenceChange, true, true, 1000), true);
			...
			UIConstants.updateCalloutContent("#camp-overview tr#" + rowID + " .camp-overview-stats-rumours", "传闻: " + UIConstants.roundValue(rumoursChange, true, true, 1000), true);
			...
			UIConstants.updateCalloutContent("#camp-overview tr#" + rowID + " .camp-overview-stats-hope", "希望: " + UIConstants.roundValue(hopeChange, true, true, 1000), true);
		},

		getAlertDescription: function (notificationType) {
			switch (notificationType) {
				case this.campNotificationTypes.EVENT_RAID_ONGOING: return "袭击";
				case this.campNotificationTypes.EVENT_TRADER: return "商人";
				case this.campNotificationTypes.EVENT_RECRUIT: return "招募者";
				case this.campNotificationTypes.EVENT_REFUGEES: return "难民";
				case this.campNotificationTypes.EVENT_DISEASE: return "疾病";
				case this.campNotificationTypes.EVENT_VISITOR: return "访客";
				case this.campNotificationTypes.POP_UNASSIGNED: return "未分配工人";
				case this.campNotificationTypes.POP_DECREASING: return "人口减少";
				case this.campNotificationTypes.BUILDING_DAMAGED: return "损坏建筑";
				case this.campNotificationTypes.EVENT_OUTGOING_CARAVAN: return "外出商队";
				default: return "";
			}
		},
