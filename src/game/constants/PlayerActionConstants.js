...
function (Ash, PlayerActionData, ObjectUtils, GameConstants, CampConstants, ImprovementConstants) {
	...
	var PlayerActionConstants = {
		...
		getActionBusyDescription: function (baseActionID) {
			switch (baseActionID) {
				case "use_in_home": return "休息中";
				case "use_in_campfire": return "交谈中";
				case "use_in_campfire_2": return "点燃中";
				case "use_in_hospital": return "恢复中";
				case "use_in_hospital_2": return "增强中";
				case "use_in_market": return "访问中";
				case "use_in_library": return "学习中";
				case "use_in_temple": return "捐赠中";
				case "use_in_shrine": return "冥想中";
				case "clear_waste_t": return "清理废物";
				case "clear_waste_r": return "清理废物";
				case "launch": return "发射";
