	...
	var CampConstants = {
		...
		workerTypes: {
			...
			apothecary: {
				...
				getLimitText: function (num) { return "建造了" + num + "个药房"; },
			},
			toolsmith: {
				id: "toolsmith",
				...
				getLimitText: function (num) { return "建造了" + num + "个铁匠铺"; },
			},
			concrete: {
				id: "concrete",
				...
				getLimitText: function (num) { return "建造了" + num + "个水泥厂"; },
			},
			robotmaker: {
				id: "robotmaker",
