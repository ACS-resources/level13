...
function (Ash, PlayerActionConstants, ItemConstants, UpgradeConstants, BagConstants, WorldConstants, TradingPartnerVO, IncomingCaravanVO, ResourcesVO, ResultVO) {
	...
	var TradeConstants = {
		...
		TRADING_PARTNERS: [
			new TradingPartnerVO(3, "骨十字", [resourceNames.rope], [resourceNames.metal], false, true, [ "weapon" ], [ "weapon", "clothing_over", "clothing_upper", "clothing_lower", "clothing_hands", "clothing_head", "exploration" ]),
			new TradingPartnerVO(4, "铁拳", [resourceNames.food], [resourceNames.metal], false, true, [], ["exploration", "shoes" ]),
			...
			new TradingPartnerVO(7, "磨坊路学会", [resourceNames.water, resourceNames.food], [resourceNames.metal], true, false, [], [ "weapon", "artefact" ]),
			new TradingPartnerVO(10, "苍松", [resourceNames.medicine, resourceNames.herbs, resourceNames.rubber], [resourceNames.rope], true, false, [], [ "artefact", "exploration" ]),
			new TradingPartnerVO(12, "海格特", [resourceNames.tools], [resourceNames.rope, resourceNames.herbs], true, false, [], [ "clothing_over", "clothing_upper", "clothing_lower", "clothing_hands", "clothing_head" ]),
