...
define(['ash',
  ...
  function (Ash, DescriptionMapper, Text, TextBuilder, GameConstants, EnemyConstants, ItemConstants, SectorConstants, PositionConstants, MovementConstants, TradeConstants, WorldConstants) {
    ...
    function initSectorTexts() {
      ...
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个 [n-street] 在一个 [a-building] [n-building] 前");
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个 [a-street]的[n-street] 位于两个 [a-building] [n-buildings] 之间");
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个 [a-street]的[n-street] 位于两个 [n-buildings] 之间，两边各有一些 [a-building] [n-buildings]");
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个 [a-street]的[n-street] 与少数 [a-building] [n-buildings] 一同出现");
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个 [a-street] [n-sector] 散布着 [an-items] 和 [an-items]");
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个 [a-street]的[n-street] 两旁是 [a-building] [n-buildings]");
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个 [a-street]的[n-street] 被 [n-buildings] 包围");
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个 [a-street]的[n-street] 被 [a-building] [n-buildings] 包围");
      ...
      DescriptionMapper.add("sector-vision", { buildingDensity: b22 }, "某种[a-sectortype]综合体，有几条狭窄的通道");
      DescriptionMapper.add("sector-vision", { buildingDensity: b13 }, "一个宽阔的广场，一侧是一个 [a-building] [n-building]，另一侧似乎是 一个 [a-building] [n-building] 的遗迹");
      ...
      DescriptionMapper.add("sector-vision", { buildingDensity: b33 }, "一个 [a-street]的[n-street] 挤满了 [a-building] [n-buildings] 和 [an-decos]，几乎没有足够的空间通过");
      ...
      DescriptionMapper.add("sector-vision", { wear: b23, damage: b0 }, "曾经是 [a-street-past] [n-sector]，中间有一些 [an-decos] 和一个 [a-building] [n-building]");
      ...
      DescriptionMapper.add("sector-vision", { sectorType: t_M }, "一个 [a-street]的[n-street] 在 一个 [n-building] 后面，低矮的天花板交错着旧电线和管道");
