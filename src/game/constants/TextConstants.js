...
define(['ash',
  ...
  function (Ash, DescriptionMapper, Text, TextBuilder, GameConstants, EnemyConstants, ItemConstants, SectorConstants, PositionConstants, MovementConstants, TradeConstants, WorldConstants) {
    ...
    function initSectorTexts() {
      ...
      DescriptionMapper.add("sector-vision", { sectorType: wildcard }, "一个[a-street]的[n-street] 位于两个 [n-buildings] 之间，两边各有一些 [a-building]的[n-buildings]");
      ...
      DescriptionMapper.add("sector-vision", { buildingDensity: b33 }, "某种一个[a-sectortype] 走廊位于两座巨大 [n-buildings] 之间，几乎没有足够的空间行走");
