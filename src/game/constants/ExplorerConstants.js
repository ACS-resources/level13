define(['ash',
	...
	let ExplorerConstants = {
		...
		predefinedExplorers: {
			2: { id: "gambler", localeType: localeTypes.maintenance, abilityType: "attack", name: "伊敏", icon: "img/characters/explorer_unique_gambler.png", dialogueSource: "explorer_unique_gambler" },
			3: { id: "dog", localeType: localeTypes.warehouse, abilityType: "scavenge_capacity", name: "狗", icon: "img/characters/animal_dog.png", dialogueSource: "explorer_generic_dog_01", animalType: "dog" },
			4: { id: "journalist", localeType: localeTypes.library, abilityType: "stat_evidence", name: "叶夫里", icon: "img/characters/explorer_unique_journalist.png", dialogueSource: "explorer_unique_journalist" },
			5: { id: "handler", localeType: localeTypes.house, abilityType: "scavenge_handler", name: "杰泽卡亚", icon: "img/characters/explorer_unique_handler.png", dialogueSource: "explorer_unique_handler" },
			6: { id: "prospector", localeType: localeTypes.store, abilityType: "scavenge_blueprints", name: "苏妮塔", icon: "img/characters/explorer_unique_prospector.png", dialogueSource: "explorer_unique_prospector" },
			10: { id: "hermit", localeType: localeTypes.bunker, abilityType: "cost_collectors", name: "伊利亚斯科", icon: "img/characters/explorer_unique_hermit.png", dialogueSource: "explorer_unique_hermit" },
		},
		...
		getExplorerTypeDisplayName: function (explorerType) {
			switch (explorerType) {
				case this.explorerType.FIGHTER: return "战士";
				case this.explorerType.SCOUT: return "侦查兵";
				case this.explorerType.SCAVENGER: return "拾荒者";
				default:
		...
		getPronoun: function (explorer) {
			if (this.isAnimal(explorer.abilityType)) return "它";
			if (explorer.gender == CultureConstants.genders.FEMALE) return "她";
			if (explorer.gender == CultureConstants.genders.MALE) return "他";
			return "他们";
		},
