	...
	let TutorialConstants = {
		...
		tutorials: {
			...
			TUTORIAL_BUILT_STABLE: {
				triggers: [ "action_build" ],
				repeats: "NEVER",
				logMessage: "建造了一个马车大棚. 我们现在可以派出自己的贸易队伍了. ",
			...
			TUTORIAL_BUILT_TEMPLE: {
				triggers: [ "action_build" ],
				repeats: "NEVER",
				logMessage: "寺庙建造完成. 人们可以在此共同探索新的信仰. ",
			...
			TUTORIAL_ENCOUNTER_BLOCKER_TYPE_GAP_NO_TECH: {
				...
				repeats: "NEVER",
				delay: 1500,
				logMessage: "此处有一个巨大裂缝. 需要寻找架桥方法才能通过. ",
			...
			TUTORIAL_ENCOUNTER_BLOCKER_TYPE_GAP_HAS_TECH: {
				...
				repeats: "NEVER",
				delay: 1500,
				logMessage: "此处有一个巨大裂缝，但营地工人可以架桥通过. ",
			...
			TUTORIAL_ENCOUNTER_LEVEL_14_RADIATION: {
				...
				repeats: "NEVER",
				delay: 1500,
				logMessage: "这里辐射严重，需要更精良的装备才能探索. ",
			...
			TUTORIAL_ENCOUNTER_OUTPOST: {
				...
				repeats: "NEVER",
				delay: 1500,
				logMessage: "这层的人口稀疏, 营地里的人口增速会变慢. " ,
			...
			TUTORIAL_FEATURE_UNLOCKED_MILESTONES: {
				...
				repeats: "NEVER",
				delay: 1500,
				logMessage: "营地很小, 但它会蓬勃成长. 在一起, 我们能创造奇迹. " ,
			...
			TUTORIAL_FOUND_FOOD: {
				...
				repeats: "NEVER",
				delay: 0,
				logMessage: "找到了一些废金属, 或许可以用来合成. " ,
				conditions: { playerInventory: { resource_metal: [1, -1] } }
			},
			TUTORIAL_FOUND_ROPE: {
				triggers: [ "action_collect_rewards" ],
				repeats: "NEVER",
				logMessage: "找到了一些绳子, 或许可以用来建筑和合成. " ,
			...
			TUTORIAL_FOUND_MEDICINE: {
				triggers: [ "action_collect_rewards" ],
				repeats: "NEVER",
				logMessage: "找到了一些药品, 那是之前安全时期的稀有遗产. " ,
